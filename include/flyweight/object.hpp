...
> struct object final {
  ...
  template <
	  ...
	  std::conjunction<
	  std::negation<std::is_same<std::decay_t<Args>, object>...>,
...
template <class U, class E, class A, class T>
static inline bool operator == (object<U, E, A, T> const& lhs, U const& rhs) {
...
template <class U, class E, class A, class T>
static inline void swap (object<U, E, A, T>& lhs, object<U, E, A, T>& rhs) noexcept(
