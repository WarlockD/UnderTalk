...
//{ 1, {  1, 16777215, -20, -20, -global.idealborder[1] - 55, 1, 1, 94, 16, 32 } },
{ 2, { 4, 0,0,0, 190,  43, 2, 95, 9, 20 }},
{ 3, { 7, 8421376, 100 , 39, 3, 95, 10, 10  }},
{ 4, {  2, 16777215, -20, -20, -290, 0, 1, 101, 8, 18 } },
{ 5, {  2, 16777215, -20, -20, -290, 0, 1, 95, 8, 18 } },

{ 6, { 4, 0,0,0, 200 , 0, 1, 97, 9, 20 }},
{ 7, { 4, 0,0,0, 200 , 2, 2, 98, 9, 20 }},
{ 8, { 4, 0,0,0, 200 , 0, 1, 101, 9, 20 }},
{ 9, {  2, 16777215, -20, -20, -290, 0, 1, 97, 8, 18 } },
{ 10, {  2, 16777215, -20, -20, -290, 0, 1, 96, 8, 18 } },
{ 11, {  2, 16777215, -20, -20, -290, 0, 2, 94, 9, 18 } },
{ 12, { 4, 0,0,0, 200 , 1, 3, 99, 10, 20 }},
{ 13, { 4, 0,0,0, 200 , 2, 4, 99, 11, 20 }},
{ 14, { 4, 0,0,0, 200 , 3, 5, 99, 14, 20 }},
{ 15, { 4, 0,0,0, 200 , 0, 10, 99, 18, 20 }},
{ 16, {  2, 16777215, -20, -20, -290, 1.2f, 2, 98, 8, 18 } },
{ 17, {  8, 16777215, -20, -20, -290, 0, 1, 88, 8, 18 } },
// 19) global.typer = 18;
{ 18, {  9, 16777215, -20, -20, -290, 0, 1, 87, 11, 18 } },
{ 20, { 5, 0,0,0, 200 , 0, 2, 98, 25, 20 }},
{ 21, {  2, 16777215, -20, -20, -290, 0, 4, 96, 10, 18 } },
{ 22, { 9, 0, 10, 0, 200 , 1, 1, 87, 11, 20 }},
{ 23, {  2, 16777215, -20, -20, -310, 0, 1, 95, 8, 18 } },
{ 24, {  2, 16777215, -20, -20, -310, 0, 1, 65, 8, 18 } },
{ 27, {  2, 16777215, -20, -20, -290, 0, 3, 56, 8, 18 } },
{ 28, {  2, 16777215, -20, -20, -290, 0, 2, 65, 8, 18 } },
...
{ 34, {  0, 16777215, -20, -20, -290, 0, 3, 71, 16, 18 } },
{ 35, {  2, 16777215, -20, -20, -290, 0, 2, 84, 10, 18 } },
{ 36, {  2, 16777215, -20, -20, -290, 0, 8, 85, 10, 18 } },
{ 37, {  2, 16777215, -20, -20, -290, 0, 1, 78, 8, 18 } },
{ 38, {  2, 16777215, -20, -20, -290, 0, 6, 78, 8, 18 } },
...
{ 47, {  2, 16777215, -20, -20, -290, 0, 1, 83, 8, 18 } },
{ 48, {  8, 16777215, -20, -20, -290, 0, 1, 89, 8, 18 } },
...
{ 60, {  2, 16777215, -20, -20, -290, 0, 2, 90, 8, 18 } },
...
{ 76, {  2, 16777215, -20, -20, -290, 0, 1, 84, 8, 18 } },
{ 77, { 4, 0,0,0, 200 , 0, 4, 98, 9, 20 }},
{ 78, { 4, 0,0,0, 200 , 2, 3, 98, 9, 20 }},
{ 79, {  2, 16777215, -20, -20, -290, 0, 2, 85, 8, 18 } },
...
{ 89, {  2, 16777215, -20, -20, -290, 0, 1, 84, 8, 18 } },
{ 90, {  2, 16777215, -20, -20, -290, 0, 3, 84, 8, 18 } },
...
{ 100, {  2, 16777215, -20, -20, -290, 0, 1, 96, 8, 18 } },
...
{ 666, {  0, 16777215, -20, -20, -290, 1, 4, 71, 16, 18 } }
...
//	setup = { 1, Color::White, FloatRect(pos.x + 20, pos.y + 20, 290,0.0f), 1,1,94,16,32 };
	auto it = setups.find(type);
	assert(it != setups.end());
	setup = it->second;
#if 0
	switch (type) {
	//case 4: 
...
#endif
	if (setup.writingx < 0) setup.writingx = static_cast<int>(std::round(getPosition().x)) +-setup.writingx;
	if (setup.writingy < 0) setup.writingy = static_cast<int>(std::round(getPosition().y)) + -setup.writingy;
	if (setup.writingxend < 0)  setup.writingxend = 0 + -setup.writingxend; // FIX
